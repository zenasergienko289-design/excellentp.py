...
BOT_TOKEN = "8983793121:AAFrJLqQeBDA_9AUuQsEBKic60x7TZjmCsg"
...
ADMIN_LINK = "https://t.me/gifthelper_otc"  # Ссылка на менеджера для пополнения
...
async def start_command(message: types.Message, state: FSMContext, command: CommandObject = None):
    ...
    if args and args in deals:
        ...
        text = (
            ...
            f"В случае если вы отправили транзакцию без комментария, напишите менеджеру - @gifthelper_otc"
        )
